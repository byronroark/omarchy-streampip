...
sed -i '/^-- StreamPiP: arrange every active PiP to match the focused PiP\.$/d; /^o.bind("SUPER + SHIFT + ALT + T", "Arrange StreamPiP", "stream-pip-layout --arrange")$/d' "$hypr_dir/bindings.lua"
